...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-10" style="background-color: #fafafa">list hospital
		...
		<table class="table table-striped table-bordered table-condensed">
				...
				<tr>
					...
					<?php
				//echo $_SESSION['un'];
					while($h_list=mysqli_fetch_array($result1)) {
					
						$id=$h_list['hospital_id'];
							
						echo "<tr>";
						echo "<td>".$h_list['hospital_id']."</td>";
						echo "<td>".$h_list['hospital_name']."</td>";
						echo "<td>".$h_list['hospital_phone']."</td>";
						echo "<td>".$h_list['hospital_address']."</td>";
						echo "<td>"."<a href='sa_edit_hospital.php?id=$id'>Edit |</a>"."<a href='sa_remove hospital.php?id=$id'>| Remove |</a>"."<a href='sa_add_user_hospital.php?id=$id'>| Add User</a>"."</td>";
						echo "</tr>";
